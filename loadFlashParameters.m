classdef loadFlashParameters % Analysis of synchronization file. Length, timing and number of flashes. Frames during hardcoded to 77. uncoment to change
    ...
    methods
        ...
        function [flashStart,...
            ...
            framesBeforeFlash =25;%floor(77/2); %floor(flashStop(2)-flashStart(2));
            framesDuringFlash = 77;%45; %flashStop(2)-flashStart(2);77
            framesAfterFlash  = 52;%77; %floor((flashStop(2)-flashStart(2))*2);
            framesTotal = ...
                framesBeforeFlash + ...
                framesDuringFlash + ...
                framesAfterFlash;
