function plotOneSEM(ROI_list,slowParams,color,lim_y,t)
    ...
    for type=t
        ...
        SEM=ROI_list.stdSlow(:,type)'./sqrt(5);
        areaStd= [ROI_list.meanSlow(:,type)'+SEM, fliplr(ROI_list.meanSlow(:,type)'-SEM)];
